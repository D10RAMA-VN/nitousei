...
$('#bmusic').click(
  function(){
    if (x == 2) {
      $('#audiotag').attr('src','data/bgm/main.mp3');
      x = 1;
      $('.m_title').css('border-left','solid 4px rgba(0,0,0,0)');
