  ...
  <div class='tab-content'>
   <div class='content1'>
	<div class="config_body">
			<div class="range">
				<p><span style="display:inline-block;margin-top:60px;margin-left:-200px;width:300px;text-align:right;">BGM 音量</span></p>
            ...
            <div class="unread_area" id="unread_check" style="left:160px;top:494px;position:absolute;font-family:ubuntu-italic;">
            ...
            <div class=min_max style="left:133px;top:147px;">min</div><div class=min_max style="left:810px;top:148px;">MAX</div>
            <div class=min_max style="left:133px;top:230px;">min</div><div class=min_max style="left:810px;top:231px;">MAX</div>
