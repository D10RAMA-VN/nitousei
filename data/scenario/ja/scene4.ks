...
[hide][hokuto_s_mu]
#北斗
「…うちの親父の主治医が、美波のお父さんだったんです。」[p][stopse buf=1]
#
[hide][seizi_magao]
#高村
「……！」[p][stopse buf=3]
...
#北斗
[hs/kanasimi]
「それで美波のお父さんが治療してくれたけど、[r]　まあさっき言った通りダメで。それで……」[p][stopse buf=1]
#北斗
[hs/mu2]
...
#北斗
[hs/mu]
「こっちは別に、お父さんの処置が悪かったわけでもないし、[r]　気にしてないのに…」[p][stopse buf=1]
#北斗
[hs/kanasimi]
...
#高村
「それなのに美波君のところではなく私のところに来たということは、[r]　何かしらの答えが欲しい、そうでなければ美波君と話せない、」[p][stopse buf=3]
#高村
...
@jump storage="ja/scene5.ks" target=*chapter5
