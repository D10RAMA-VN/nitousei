...
$("#page1").hover(function(){$("#page1").css( "background-color", "#007882" );},function(){$("#page1").css( "background-color", "rgba(0,0,0,0)" );});
$("#page2").hover(function(){$("#page2").css( "background-color", "#007882" );},function(){$("#page2").css( "background-color", "rgba(0,0,0,0)" );});
$("#page3").hover(function(){$("#page3").css( "background-color", "#007882" );},function(){$("#page3").css( "background-color", "rgba(0,0,0,0)" );});
$("#page4").hover(function(){$("#page4").css( "background-color", "#007882" );},function(){$("#page4").css( "background-color", "rgba(0,0,0,0)" );});
$("#page5").hover(function(){$("#page5").css( "background-color", "#007882" );},function(){$("#page5").css( "background-color", "rgba(0,0,0,0)" );});
